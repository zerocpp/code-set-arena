...
新版本目录：
~/workspace/codesetarena/student/codesetarena-student-local-v7.1.7-linux-amd64
...
```bash
mkdir -p ~/workspace/codesetarena/student
cd ~/workspace/codesetarena/student
```
...
```bash
cd ~/workspace/codesetarena/student/codesetarena-student-local-v7.1.7-linux-amd64
```
